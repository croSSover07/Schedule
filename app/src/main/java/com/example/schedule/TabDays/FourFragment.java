...
//    String[] values=new String[]{"Системний аналіз \nЛимаренко Ю.О. \nлаб ОЦ-3 2нг", "Системний аналіз \nЛимаренко Ю.О.\nлек ауд.38","Архітектура та проектування програмного забезпечення \nБезверхий А.І.\nлек ауд40","Архітектура та проектування програмного забезпечення \n Безверхий А.І \nлаб ОЦ-3"};
    ListView lv;
    public FourFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_four_fragment,null);
        perform(v);
        return v;
    }
    public void perform(View v) {
        ...
        ArrayList<classes> day= mweek.getThursday();
