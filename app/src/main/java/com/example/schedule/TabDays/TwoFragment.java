...
public class TwoFragment  extends Fragment {
  /*  String[] values=new String[]{"Системний аналіз \nЛимаренко Ю.О. \n лаб ОЦ-3  1нг","Системний аналіз \nЛимаренко Ю.О.\nлек ауд.38","Менеджмент проектів програмного забезпечення \nНовікова О.С.\nлек ауд. 38 ","Системний аналіз \n" +
            "Лимаренко Ю.О. \n" +
            " лаб ОЦ-3  2нг"};*/
    ListView lv;
    public TwoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_two_fragment,null);
        perform(v);
        return v;
    }
    public void perform(View v) {
        ...
        ArrayList<classes> day= mweek.getTuesday();
